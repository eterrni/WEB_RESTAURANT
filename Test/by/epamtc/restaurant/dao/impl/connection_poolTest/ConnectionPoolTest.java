package by.epamtc.restaurant.dao.impl.connection_poolTest;
...
import by.epamtc.restaurant.dao.impl.connection_poolTest.db_propertiesTest.DBParameterTest;
import by.epamtc.restaurant.dao.impl.connection_poolTest.db_propertiesTest.DBResourceManagerTest;
...
public final class ConnectionPoolTest {
	...
	private ConnectionPoolTest() {
		...
		this.driverName = dbResourceManager.getValue(DBParameterTest.DB_DRIVER);
		this.url = dbResourceManager.getValue(DBParameterTest.DB_URL);
		this.user = dbResourceManager.getValue(DBParameterTest.DB_USER);
		this.password = dbResourceManager.getValue(DBParameterTest.DB_PASSWORD);
		try {
			this.poolSize = Integer.parseInt(dbResourceManager.getValue(DBParameterTest.DB_POLL_SIZE));
		...
		try {
			...
			logger.error("Error init connection pool");
		}
