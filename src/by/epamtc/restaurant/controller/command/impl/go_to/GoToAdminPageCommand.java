...
//import by.epamtc.restaurant.controller.command.impl.utility.DownloadClientsOrderUtility;
...
public class GoToAdminPageCommand implements Command {
	...
	// private static final DownloadClientsOrderUtility downloadClientsOrder = DownloadClientsOrderUtility.getInstance();
	...
	//		downloadClientsOrder.download(request, response);
